...
use utils::{hash::FxHashMap, math::lcm_single, Solution};
...
pub fn solve(input: &str) -> Solution {
    ...
    let mut pulse_counts: [u64; 2] = [0, 0];
    ...
    let part_2: u64 = cycles
        .into_values()
        .fold(1, |prev, current| lcm_single(prev, current.unwrap())) as u64;

    (pulse_counts[0] * pulse_counts[1], part_2).into()
}
